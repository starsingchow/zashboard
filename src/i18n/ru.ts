...
const ru: LANG_MESSAGE = {
  ...
  chainSourcePreviewReady: 'Предпросмотр актуален. Можно сохранить.',
  chainSourceRequiredFields: 'Заполните ID, имя и содержимое источника перед предпросмотром.',
  chainSourceSaved: 'Источник сохранен.',
  ...
  chainProxyURITextPlaceholder:
    'Вставьте по одному proxy URI на строку, например ss://, vmess://, vless://, trojan://. Для http(s)-ссылок используйте URL подписки.',
