...
const ru: LANG_MESSAGE = {
  ...
  // localClash Chain
  chainTitle: 'localClash Chain',
  chainSessionTitle: 'Доступ localClash',
  chainSetupToken: 'Токен настройки',
  chainLogin: 'Войти',
  chainSetup: 'Настроить',
  chainLogout: 'Выйти',
  chainEntryProviders: 'Входные провайдеры',
  chainOwnedExits: 'Собственные выходы',
  chainRoutes: 'Маршруты',
  chainActions: 'Действия',
  chainWarnings: 'Предупреждения',
  chainMode: 'Режим',
  chainRuntime: 'Runtime',
  chainName: 'Имя',
  chainEntryProviderName: 'Имя провайдера',
  chainUrl: 'URL',
  chainPath: 'Путь',
  chainInterval: 'Интервал',
  chainInclude: 'Включить',
  chainExclude: 'Исключить',
  chainUserAgent: 'User agent',
  chainPreview: 'Предпросмотр',
  chainSave: 'Сохранить',
  chainEdit: 'Изменить',
  chainSecretSet: 'Secret set',
  chainNodeCount: 'Узлы',
  chainSamples: 'Примеры',
  chainFormat: 'Формат',
  chainOwnedExitImport: 'Импорт выходов',
  chainYamlOrUrl: 'YAML или URL',
  chainYaml: 'YAML',
  chainCandidates: 'Кандидаты',
  chainManualExit: 'Ручной выход',
  chainCredentialKind: 'Тип учетных данных',
  chainCredentialValue: 'Значение учетных данных',
  chainCredentialRef: 'Credential ref',
  chainRelay: 'Relay',
  chainEntryProvidersField: 'Входные провайдеры',
  chainHealthUrl: 'Health URL',
  chainExitIpUrl: 'Exit IP URL',
  chainExpectedExitIp: 'Ожидаемый exit IP',
  chainPreviewRequired: 'Сначала выполните предпросмотр текущей формы.',
  chainImportPreview: 'Предпросмотр импорта',
  chainImportCommit: 'Commit import',
  chainSelectCandidate: 'Select',
  chainSaveCandidate: 'Сохранить кандидата',
  chainExit: 'Выход',
  chainMatchType: 'Тип совпадения',
  chainMatchValues: 'Значения совпадения',
  chainRouteTarget: 'Цель',
  chainDefaultRoute: 'Маршрут по умолчанию',
  chainAOnly: 'Только A',
  chainRender: 'Render',
  chainValidate: 'Validate',
  chainTest: 'Test',
  chainTestChain: 'Тест цепи',
  chainTesting: 'Тестирование...',
  chainTestOk: 'ОК',
  chainTestWarn: 'Предупреждение',
  chainTestFailed: 'Ошибка',
  chainApply: 'Apply',
  chainLastAction: 'Последнее действие',
  chainConfigSummary: 'Сводка конфигурации',
  chainNoWarnings: 'Нет предупреждений',
  chainNoActionOutput: 'Нет вывода действий',
  chainNoEntries: 'Нет входных провайдеров',
  chainNoExits: 'Нет собственных выходов',
  chainNoRoutes: 'Нет маршрутов',
  chainOverview: 'Обзор',
  chainRules: 'Правила',
  chainSource: 'Источник',
  chainType: 'Тип',
  chainStatus: 'Статус',
  chainDelete: 'Удалить',
  chainRefresh: 'Обновить',
  chainSaved: 'Сохранено',
  chainRuleSources: 'Источники правил',
  chainNoRuleSourceResults: 'Результаты источников правил отсутствуют',
  chainManagedSources: 'Управляемые источники',
  chainManagedNodes: 'Управляемые узлы',
  chainRuleOverrides: 'Переопределения правил',
  chainRuleProfile: 'Профиль правил',
  chainFixedExitCandidate: 'Кандидат фиксированного выхода',
  chainNotEntry: 'Не вход',
  chainSubscriptionURL: 'URL подписки',
  chainProxyURIText: 'Текст Proxy URI',
  chainYamlPaste: 'Вставка YAML',
  chainYamlUploadText: 'Текст YAML',
  chainPasteSourcePlaceholder: 'Вставьте строки Proxy URI или Mihomo YAML',
  chainSearchNodes: 'Искать узлы',
  chainNode: 'Узел',
  chainProtocol: 'Протокол',
  chainServer: 'Сервер',
  chainTags: 'Теги',
  chainImportedSourceRules: 'Правила импортированного источника',
  chainShadowrocketDefault: 'Shadowrocket по умолчанию',
  chainUnmanagedRules: 'Неуправляемые правила',
  chainImportedSource: 'Импортированный источник',
  chainImportedRuleId: 'ID импортированного правила',
  chainDisableImported: 'Отключить импортированное',
  chainOverride: 'Переопределение',
  chainState: 'Состояние',
  chainEnabled: 'Включено',
  chainDisabled: 'Отключено',
  chainService: 'Сервис',
  chainFixedExit: 'Фиксированный выход',
  chainSelectFixedExit: 'Выберите фиксированный выход',
  chainEntrySelector: 'Селектор входа',
  chainSaveServiceChain: 'Сохранить цепочку сервиса',
  chainPreviewTitle: 'Предпросмотр источника',
  chainServiceChains: 'Служебные цепочки',
  chainSources: 'Источники',
  chainSaveProfile: 'Сохранить профиль',
  chainAddRule: 'Добавить правило',
  chainNoSources: 'Нет источников',
  chainNoNodes: 'Нет узлов',
  chainNoRules: 'Нет переопределений',
  chainNoServiceChains: 'Нет служебных цепочек',
  chainCustom: 'Пользовательский',
  chainTemplate: 'Шаблон',
  chainRuleSource: 'Источник правил',
  chainPackName: 'Имя пакета',
  chainMatchRules: 'Правила совпадений',
  chainDomain: 'Домен',
  chainDomainSuffix: 'Суффикс домена',
  chainDomainKeyword: 'Ключевое слово домена',
  chainIpCidr: 'IP CIDR',
  chainGeoip: 'GeoIP',
  chainRuleSet: 'Набор правил',
