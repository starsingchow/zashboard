...
const zh: LANG_MESSAGE = {
  ...
  // localClash Chain
  chainTitle: 'localClash 链路',
  chainSessionTitle: 'localClash 访问',
  chainSetupToken: '设置令牌',
  chainLogin: '登录',
  chainSetup: '初始化',
  chainLogout: '退出登录',
  ...
  chainSave: '保存',
  chainEdit: '编辑',
  chainSecretSet: '密钥已设置',
  chainNodeCount: '节点数',
  chainSamples: '样例',
  chainFormat: '格式',
  chainGroups: '组',
  chainRuleProviders: '规则提供者',
  chainRuleTargets: '规则目标',
  chainOwnedExitImport: '导入出口',
  chainYamlOrUrl: 'YAML 或 URL',
  chainYaml: 'YAML',
  chainCandidates: '候选项',
  chainManualExit: '手动出口',
  chainCredentialKind: '凭据类型',
  chainCredentialValue: '凭据值',
  chainCredentialRef: '凭据引用',
  chainRelay: '中继',
  chainEntryProvidersField: '入口提供商',
  chainHealthUrl: '健康检查 URL',
  chainExitIpUrl: '出口 IP URL',
  chainExpectedExitIp: '期望出口 IP',
  chainPreviewRequired: '保存前请先预览当前表单。',
  chainSourcePreviewReady: '预览已更新，可以保存。',
  chainSourceRequiredFields: '请先填写源 ID、名称和内容，再预览。',
  chainSourceSaved: '源已保存。',
  chainImportPreview: '预览导入',
  chainImportCommit: '提交导入',
  chainSelectCandidate: '选择',
  chainSaveCandidate: '保存候选项',
  chainExit: '出口',
  chainMatchType: '匹配类型',
  chainMatchValues: '匹配值',
  chainRouteTarget: '目标',
  chainDefaultRoute: '默认路由',
  chainAOnly: '仅 A 入口',
  chainRender: '渲染',
  chainValidate: '校验',
  chainTest: '测试',
  ...
  chainNoWarnings: '暂无告警',
  chainNoActionOutput: '暂无操作输出',
  chainNoEntries: '暂无入口提供商',
  chainNoExits: '暂无自有出口',
  chainNoRoutes: '暂无路由',
  chainOverview: '概览',
  chainRules: '规则',
  ...
  chainDelete: '删除',
  chainSaved: '已保存',
  chainManagedSources: '托管源',
  chainManagedNodes: '托管节点',
  chainRuleOverrides: '规则覆盖',
  chainRuleProfile: '规则来源',
  chainFixedExitCandidate: '固定出口候选',
  chainNotEntry: '非入口',
  chainSubscriptionURL: '订阅 URL',
  chainProxyURIText: 'Proxy URI 文本',
  chainYamlPaste: '粘贴 YAML',
  chainYamlUploadText: '上传 YAML 文本',
  chainPasteSourcePlaceholder: '粘贴 Proxy URI 行或 Mihomo YAML',
  chainProxyURITextPlaceholder:
    '每行粘贴一个代理 URI，例如 ss://、vmess://、vless://、trojan://。http(s) 订阅链接请选择订阅 URL。',
  chainSearchNodes: '搜索节点',
  chainNode: '节点',
  chainProtocol: '协议',
  chainServer: '服务器',
  chainTags: '标签',
  chainImportedSourceRules: '导入源规则',
  chainShadowrocketDefault: 'Shadowrocket 默认',
  chainUnmanagedRules: '不托管规则',
  chainImportedSource: '导入源',
  chainImportedRuleId: '导入规则 ID',
  chainDisableImported: '禁用导入规则',
  chainOverride: '覆盖项',
  chainState: '状态',
  chainEnabled: '启用',
  chainDisabled: '禁用',
  chainService: '服务',
  chainFixedExit: '固定出口',
  chainSelectFixedExit: '选择固定出口',
  chainEntrySelector: '入口选择器',
  chainSaveServiceChain: '保存服务链',
  chainPreviewTitle: '源预览',
  chainServiceChains: '服务链',
  chainSources: '源',
  chainSaveProfile: '保存配置',
  chainAddRule: '新增规则',
  chainNoSources: '暂无源',
  chainNoNodes: '暂无节点',
  chainNoRules: '暂无规则覆盖',
  chainNoServiceChains: '暂无服务链',
