...
const zhTW: LANG_MESSAGE = {
  ...
  // localClash Chain
  chainTitle: 'localClash 鏈路',
  chainSessionTitle: 'localClash 存取',
  chainSetupToken: '設定權杖',
  chainLogin: '登入',
  chainSetup: '初始化',
  chainLogout: '登出',
  chainEntryProviders: 'A 入口提供商',
  chainOwnedExits: 'B 自有出口',
  chainRoutes: '路由',
  chainActions: '操作',
  chainWarnings: '警告',
  chainMode: '模式',
  ...
  chainSave: '儲存',
  chainEdit: '編輯',
  chainSecretSet: '密鑰已設定',
  chainNodeCount: '節點數',
  chainSamples: '範例',
  chainFormat: '格式',
  chainGroups: '組',
  chainRuleProviders: '規則提供者',
  chainRuleTargets: '規則目標',
  chainOwnedExitImport: '匯入出口',
  chainYamlOrUrl: 'YAML 或 URL',
  chainYaml: 'YAML',
  chainCandidates: '候選項',
  chainManualExit: '手動出口',
  chainCredentialKind: '憑證類型',
  chainCredentialValue: '憑證值',
  chainCredentialRef: '憑證引用',
  chainRelay: '中繼',
  chainEntryProvidersField: '入口提供商',
  chainHealthUrl: '健康檢查 URL',
  chainExitIpUrl: '出口 IP URL',
  chainExpectedExitIp: '預期出口 IP',
  chainPreviewRequired: '儲存前請先預覽目前表單。',
  chainSourcePreviewReady: '預覽已更新，可以儲存。',
  chainSourceRequiredFields: '請先填寫源 ID、名稱和內容，再預覽。',
  chainSourceSaved: '源已儲存。',
  chainImportPreview: '預覽匯入',
  chainImportCommit: '提交匯入',
  chainSelectCandidate: '選擇',
  chainSaveCandidate: '儲存候選項',
  chainExit: '出口',
  chainMatchType: '匹配類型',
  chainMatchValues: '匹配值',
  chainRouteTarget: '目標',
  chainDefaultRoute: '預設路由',
  chainAOnly: '僅 A 入口',
  chainRender: '渲染',
  chainValidate: '驗證',
  chainTest: '測試',
  chainApply: '套用',
  chainLastAction: '最近操作',
  chainConfigSummary: '配置摘要',
  chainNoWarnings: '暫無警告',
  chainNoActionOutput: '暫無操作輸出',
  chainNoEntries: '暫無入口提供商',
  chainNoExits: '暫無自有出口',
  chainNoRoutes: '暫無路由',
  chainOverview: '概覽',
  chainRules: '規則',
  ...
  chainDelete: '刪除',
  chainSaved: '已儲存',
  chainManagedSources: '託管源',
  chainManagedNodes: '託管節點',
  chainRuleOverrides: '規則覆蓋',
  chainRuleProfile: '規則來源',
  chainFixedExitCandidate: '固定出口候選',
  chainNotEntry: '非入口',
  chainSubscriptionURL: '訂閱 URL',
  chainProxyURIText: 'Proxy URI 文字',
  chainYamlPaste: '貼上 YAML',
  chainYamlUploadText: '上傳 YAML 文字',
  chainPasteSourcePlaceholder: '貼上 Proxy URI 行或 Mihomo YAML',
  chainProxyURITextPlaceholder:
    '每行貼上一個代理 URI，例如 ss://、vmess://、vless://、trojan://。http(s) 訂閱連結請選擇訂閱 URL。',
  chainSearchNodes: '搜尋節點',
  chainNode: '節點',
  chainProtocol: '協議',
  chainServer: '伺服器',
  chainTags: '標籤',
  chainImportedSourceRules: '匯入源規則',
  chainShadowrocketDefault: 'Shadowrocket 預設',
  chainUnmanagedRules: '不託管規則',
  chainImportedSource: '匯入源',
  chainImportedRuleId: '匯入規則 ID',
  chainDisableImported: '停用匯入規則',
  chainOverride: '覆蓋項',
  chainState: '狀態',
  chainEnabled: '啟用',
  chainDisabled: '停用',
  chainService: '服務',
  chainFixedExit: '固定出口',
  chainSelectFixedExit: '選擇固定出口',
  chainEntrySelector: '入口選擇器',
  chainSaveServiceChain: '儲存服務鏈',
  chainPreviewTitle: '源預覽',
  chainServiceChains: '服務鏈',
  chainSources: '源',
  chainSaveProfile: '儲存設定',
  chainAddRule: '新增規則',
  chainNoSources: '暫無源',
  chainNoNodes: '暫無節點',
  chainNoRules: '暫無規則覆蓋',
  chainNoServiceChains: '暫無服務鏈',
