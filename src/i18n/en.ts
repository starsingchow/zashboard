const en = {
  ...
  chainSourcePreviewReady: 'Preview is current. You can save.',
  chainSourceRequiredFields: 'Fill source ID, name, and content before previewing.',
  chainSourceSaved: 'Source saved.',
  ...
  chainProxyURITextPlaceholder:
    'Paste one proxy URI per line, e.g. ss://, vmess://, vless://, trojan://. Use Subscription URL for http(s) links.',
