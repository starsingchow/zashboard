const en = {
  ...
  chainSessionTitle: 'localClash access',
  chainSetupToken: 'Setup token',
  chainLogin: 'Log in',
  chainSetup: 'Set up',
  chainLogout: 'Log out',
  chainEntryProviders: 'Entry providers',
  chainOwnedExits: 'Owned exits',
  chainRoutes: 'Routes',
  ...
  chainName: 'Name',
  chainEntryProviderName: 'Provider name',
  chainUrl: 'URL',
  chainPath: 'Path',
  chainInterval: 'Interval',
  chainInclude: 'Include',
  chainExclude: 'Exclude',
  chainUserAgent: 'User agent',
  chainPreview: 'Preview',
  chainSave: 'Save',
  chainEdit: 'Edit',
  chainSecretSet: 'Secret set',
  chainNodeCount: 'Nodes',
  chainSamples: 'Samples',
  chainFormat: 'Format',
  chainOwnedExitImport: 'Import exits',
  chainYamlOrUrl: 'YAML or URL',
  chainYaml: 'YAML',
  chainCandidates: 'Candidates',
  chainManualExit: 'Manual exit',
  chainCredentialKind: 'Credential kind',
  chainCredentialValue: 'Credential value',
  chainCredentialRef: 'Credential ref',
  chainRelay: 'Relay',
  chainEntryProvidersField: 'Entry providers',
  chainHealthUrl: 'Health URL',
  chainExitIpUrl: 'Exit IP URL',
  chainExpectedExitIp: 'Expected exit IP',
  chainPreviewRequired: 'Preview the current form before saving.',
  chainImportPreview: 'Preview import',
  chainImportCommit: 'Commit import',
  chainSelectCandidate: 'Select',
  chainSaveCandidate: 'Save candidate',
  chainExit: 'Exit',
  chainMatchType: 'Match type',
  chainMatchValues: 'Match values',
  chainRouteTarget: 'Target',
  chainDefaultRoute: 'Default route',
  chainAOnly: 'A-only',
  chainRender: 'Render',
  chainValidate: 'Validate',
  chainTest: 'Test',
  chainTestChain: 'Test Chain',
  chainTesting: 'Testing...',
  chainTestOk: 'OK',
  chainTestWarn: 'Warning',
  chainTestFailed: 'Failed',
  chainApply: 'Apply',
  chainLastAction: 'Last action',
  chainConfigSummary: 'Config summary',
  chainNoWarnings: 'No warnings',
  chainNoActionOutput: 'No action output',
  chainNoEntries: 'No entry providers',
  chainNoExits: 'No owned exits',
  chainNoRoutes: 'No routes',
  chainOverview: 'Overview',
  chainRules: 'Rules',
  chainSource: 'Source',
  chainType: 'Type',
  chainStatus: 'Status',
  chainDelete: 'Delete',
  chainRefresh: 'Refresh',
  chainSaved: 'Saved',
  chainRuleSources: 'Rule Sources',
  chainNoRuleSourceResults: 'No rule source results yet',
  chainManagedSources: 'Managed sources',
  chainManagedNodes: 'Managed nodes',
  chainRuleOverrides: 'Rule overrides',
  chainRuleProfile: 'Rule profile',
  chainFixedExitCandidate: 'Fixed exit candidate',
  chainNotEntry: 'Not entry',
  chainSubscriptionURL: 'Subscription URL',
  chainProxyURIText: 'Proxy URI text',
  chainYamlPaste: 'YAML paste',
  chainYamlUploadText: 'YAML upload text',
  chainPasteSourcePlaceholder: 'Paste proxy URI lines or Mihomo YAML',
  chainSearchNodes: 'Search nodes',
  chainNode: 'Node',
  chainProtocol: 'Protocol',
  chainServer: 'Server',
  chainTags: 'Tags',
  chainImportedSourceRules: 'Imported source rules',
  chainShadowrocketDefault: 'Shadowrocket default',
  chainUnmanagedRules: 'Unmanaged rules',
  chainImportedSource: 'Imported source',
  chainImportedRuleId: 'Imported rule ID',
  chainDisableImported: 'Disable imported',
  chainOverride: 'Override',
  chainState: 'State',
  chainEnabled: 'Enabled',
  chainDisabled: 'Disabled',
  chainService: 'Service',
  chainFixedExit: 'Fixed exit',
  chainSelectFixedExit: 'Select fixed exit',
  chainEntrySelector: 'Entry selector',
  chainSaveServiceChain: 'Save service chain',
  chainPreviewTitle: 'Source preview',
  chainServiceChains: 'Service chains',
  chainSources: 'Sources',
  chainSaveProfile: 'Save profile',
  chainAddRule: 'Add rule',
  chainNoSources: 'No sources',
  chainNoNodes: 'No nodes',
  chainNoRules: 'No rule overrides',
  chainNoServiceChains: 'No service chains',
  chainCustom: 'Custom',
  chainTemplate: 'Template',
  chainRuleSource: 'Rule source',
  chainPackName: 'Pack name',
  chainMatchRules: 'Match rules',
  chainDomain: 'Domain',
  chainDomainSuffix: 'Domain suffix',
  chainDomainKeyword: 'Domain keyword',
  chainIpCidr: 'IP CIDR',
  chainGeoip: 'GeoIP',
  chainRuleSet: 'Rule set',
